...
struct HostContainer : ContainerAPI
{
   public:
    virtual ~HostContainer() override = default;

    HostContainer(const std::string&                            name,
                     ...
                     Neon::DataView dataView = Neon::DataView::STANDARD) -> void override
    {
        ...
        if (ContainerExecutionType::host == this->getContainerExecutionType()) {
