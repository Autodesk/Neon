...
auto ContainerAPI::addToken(Neon::internal::dataDependency::Token& dataParsing)
    -> void
{
...
auto ContainerAPI::setContainerPattern(const std::vector<Neon::internal::dataDependency::Token>& tokens)
    -> void
{
