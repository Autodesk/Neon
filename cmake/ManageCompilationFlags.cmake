...
set(NeonCXXFlags
        ...
        # Ignore "Conditional expression is constant" warning until NVCC support c++20. Once that happens we can change the code to use if constexpr
        ...
        $<$<CXX_COMPILER_ID:MSVC>:-D_SCL_SECURE_NO_WARNINGS /openmp /std:c++20 /MP /W4 /WX /wd4849 /wd4127 /wd4996 /wd4505 /wd4702 /bigobj>
...
set(MSVC_XCOMPILER_FLAGS "/openmp /std:c++20  /bigobj")
set(NeonCUDAFlags
