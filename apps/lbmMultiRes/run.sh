...
echo ${exe} --numIter $numIter --deviceType gpu --deviceId $deviceId --problemType lid $problemId --benchmark --dataType $dataType --re 100 --scale $scale $collideOption $streamOption
