...
def plotme(dat_filename, label, png_filename):
    ...
    u_neon = u_neon[p]
    y_neon = y_neon[p]
    axes.plot(y_neon, 25*u_neon, 'b-', label=label)
...
plotme('NeonMultiResLBM_5000.dat', 'Neon MultiRes LBM', 'MultiResNeon_vs_ghia1982')
plotme('NeonUniformLBM_20000.dat', 'Neon Uniform LBM',  'UniformNeon_vs_ghia1982.png')