...
struct MultiXpuGraph
{
   ...
   private:
     ...
     */
    inline auto getNumDevs() const
        -> int
    {
        return mStorage->mNumDevs;
    }

    inline auto setNumDevs(int numDevs)
        -> void
    {
        mStorage->mNumDevs = numDevs;
    }
    /**
     ...
     */
    auto helpExtractTokesFromContainer(Neon::set::Container& kernelContainerIdx)
