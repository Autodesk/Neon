...
#define ADD_COMPONENT(QQ, XXX, YYY, ZZZ) \
    if constexpr ((myQ) == (QQ)) {       \
        ...
        if constexpr ((myXYZ) == 2) {    \
            ...
            ADD_COMPONENT(5, -1, -1, -1)
            ADD_COMPONENT(6, -1, 1, -1)
            ADD_COMPONENT(7, 1, 0, -1)
            ADD_COMPONENT(8, 0, 1, -1)
            ADD_COMPONENT(9, 1, 1, -1)
            ADD_COMPONENT(10, 1, -1, -1)
            ADD_COMPONENT(11, -1, -1, 0)
            ADD_COMPONENT(12, -1, 1, 0)
            ADD_COMPONENT(13, 0, 0, 0)
            ADD_COMPONENT(14, 1, 0, 0)
            ADD_COMPONENT(15, 0, 1, 0)
            ADD_COMPONENT(16, 1, 1, 0)
            ADD_COMPONENT(17, 1, -1, 0)
            ADD_COMPONENT(18, -1, 0, 1)
            ADD_COMPONENT(19, 0, -1, 1)
            ADD_COMPONENT(20, -1, -1, 1)
            ADD_COMPONENT(21, -1, 1, 1)
            ADD_COMPONENT(22, 0, 0, 1)
            ADD_COMPONENT(23, 1, 0, 1)
            ADD_COMPONENT(24, 0, 1, 1)
            ADD_COMPONENT(25, 1, 1, 1)
            ADD_COMPONENT(26, 1, -1, 1)
