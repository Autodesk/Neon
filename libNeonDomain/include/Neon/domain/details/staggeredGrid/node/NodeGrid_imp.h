...
NodeGrid<BuildingBlockGridT>::
    NodeGrid(typename BuildingBlocks::Grid& buildingBlockGrid)
{
...
template <typename BuildingBlockGridT>
auto NodeGrid<BuildingBlockGridT>::
    getPartitionIndexSpace(Neon::DeviceType,
                           SetIdx         setIdx,
...
auto NodeGrid<BuildingBlockGridT>::
    newNodeField(const std::string   fieldUserName,
                 int                 cardinality,
                 T                   inactiveValue,
...
auto NodeGrid<BuildingBlockGridT>::
    getContainerOnNodes(const std::string& name,
                        index_3d           blockSize,
                        size_t             sharedMem,
...
template <typename LoadingLambda>
auto NodeGrid<BuildingBlockGridT>::
    getContainerOnNodes(const std::string& name, LoadingLambda lambda)
        const -> Neon::set::Container
{
...
template <typename BuildingBlockGridT>
auto NodeGrid<BuildingBlockGridT>::
    getNodeToVoxelMaskField() -> typename BuildingBlocks::template Field<NodeToVoxelMask, 1>&
{
