...
inline auto NodePartitionIndexSpace<BuildingBlockGridT>::
...
template <typename BuildingBlockGridT>
NodePartitionIndexSpace<BuildingBlockGridT>::
    NodePartitionIndexSpace(const typename BuildingBlocks::PartitionIndexSpace& pixs)
{
