...
{
    using FoundationGrid = Neon::domain::details::disaggregated::bGridBlockMask::bGridBlockMask<SBlock>;

    template <typename T, int C>
    using Partition = Neon::domain::details::disaggregated::bGridBlockMask::bMaskPartition<T, C, SBlock>;
