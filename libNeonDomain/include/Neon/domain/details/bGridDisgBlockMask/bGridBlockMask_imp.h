                                       ...
                                       Neon::domain::tool::spaceCurves::EncoderType encoderType)
{
    ...
    gridName << "bGridBlockMask_" << SBlock::memBlockSizeX << "_"
...
template <typename SBlock>
template <int dummy>
auto bGridBlockMask<SBlock>::helGetMultiResDiscreteIdxSpacing() const
...
template <typename SBlock>
bGridBlockMask<SBlock>::~bGridBlockMask()
{
}
template <typename SBlock>
auto bGridBlockMask<SBlock>::getSetIdx(const index_3d& idx) const -> int32_t
{
...
template <typename SBlock>
auto bGridBlockMask<SBlock>::isInsideDomain(const index_3d& idx) const -> bool
{
...
template <typename SBlock>
auto bGridBlockMask<SBlock>::getProperties(const index_3d& idx)
...
template <typename SBlock>
auto bGridBlockMask<SBlock>::helpGetSetIdxAndGridIdx(Neon::index_3d idx)
...
template <typename SBlock>
auto bGridBlockMask<SBlock>::helpGetPartitioner1D() -> Neon::domain::tool::Partitioner1D&
{
...
template <typename SBlock>
template <typename ActiveCellLambda>
auto bGridBlockMask<SBlock>::init_mask_field(ActiveCellLambda activeCellLambda) -> void
{
