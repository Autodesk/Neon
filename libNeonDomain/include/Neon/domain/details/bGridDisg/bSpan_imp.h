...
bDisgSpan<SBlock>::setAndValidateGPUDevice([[maybe_unused]] Idx& bidx) const -> bool
{
...
template <typename SBlock>
NEON_CUDA_HOST_DEVICE inline auto
bDisgSpan<SBlock>::setAndValidateCPUDevice(Idx&            bidx,
...
template <typename SBlock>
bDisgSpan<SBlock>::bDisgSpan(typename Idx::DataBlockCount                  firstDataBlockOffset,
