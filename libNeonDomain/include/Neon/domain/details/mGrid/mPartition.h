...
class mPartition : public Neon::domain::details::bGrid::bPartition<T, C>
{
   public:
    ...
    using Idx = Neon::domain::details::bGrid::bIndex;
   ...
   public:
     ...
     */
    NEON_CUDA_HOST_DEVICE inline auto childVal(const Idx& childCell,
                                               int        card = 0) -> T&;
     ...
     * @param card the cardinality in case of vector-valued data
     */
    NEON_CUDA_HOST_DEVICE inline auto parent(const Idx& eId,
                                             int        card) -> T&;
     ...
     */
    NEON_CUDA_HOST_DEVICE inline Neon::index_3d mapToGlobal(const Idx& cell) const;


   private:
    inline NEON_CUDA_HOST_DEVICE auto childID(const Idx& cell) const -> uint32_t;
