...
void runAllTestConfiguration(
    std::function<void(TestData<G, T, C>&, Neon::sys::patterns::Engine)> f,
    std::vector<Neon::sys::patterns::Engine>                             engVec,
    int                                                                  nGpus,
    int                                                                  minNumGpus)
{
    ...
    std::vector<Neon::index_3d> dimTest{{60, 10, 250}, {11, 17, 17}};
